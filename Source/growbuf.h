...
class IGrowBuf
{
  public:
     ...
     */
    virtual __int64 add(const void *data, __int64 len)=0;
     ...
     */
    virtual __int64 getlen() const=0;
...
class GrowBuf : public IGrowBuf
{
  ...
  private:
    ...
    __int64 m_alloc;  /* allocated bytes */
    __int64 m_used;   /* how many bytes of the buffer is used? */
    __int64 m_zero;   /* should storage be zeroed out? */

  protected:
    __int64 m_bs;     // byte-size to grow by
};
