...
{
  public:
    virtual void resize(__int64 newlen)=0;
    virtual __int64  getsize() const=0;
    virtual void *get(__int64 offset, int size) const=0;
    virtual void *get(__int64 offset, int *size) const=0;
    virtual void *getmore(__int64 offset, int size) const=0;
...
class MMapFile : public IMMap
{
  ...
  public:
     ...
     */
#ifdef _WIN32
    int  setfile(HANDLE hFile, __int64 dwSize);
#else
    int  setfile(int hFile, __int64 dwSize);
#endif
    ...
    */
     ...
     */
    void *get(__int64 offset, int size) const;
     ...
     */
    void *get(__int64 offset, int *sizep) const;
     ...
     * @param size The size of the memory map window.
     */
    void *getmore(__int64 offset, int size) const;
...
class MMapFake : public IMMap
{
  ...
  public:
    ...
    void set(const char *pMem, __int64 iSize);
    __int64  getsize() const;
    void *get(__int64 offset, int size) const;
    void *get(__int64 offset, int *size) const;
    void *getmore(__int64 offset, int size) const;

    void resize(__int64 n);
    void release();
...
class MMapBuf : public IGrowBuf, public IMMap
{
  ...
  public:
    ...
    __int64  add(const void *data, __int64 len);
    void setro(BOOL bRO);
    void resize(__int64 newlen);
    __int64  getsize() const;
    __int64  getlen() const;
    void *get() const;
    void *get(__int64 offset, int *sizep) const;
    void *get(__int64 offset, int size) const;
    void *getmore(__int64 offset, int size) const;
